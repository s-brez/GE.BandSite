...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GE.BandSite.Database.Organization.EmailSuppression", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("FeedbackEventId")
                        .HasColumnType("uuid");

                    b.Property<Instant>("FirstSuppressedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<Instant>("LastSuppressedAt")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<string>("ReleaseDetail")
                        .HasMaxLength(256)
                        .HasColumnType("character varying(256)");
                    ...
                    b.Property<int>("SuppressionCount")
                        .HasColumnType("integer");

                    b.HasKey("Id");

                    b.HasIndex("FeedbackEventId");
                    ...
                    b.ToTable("EmailSuppression", "Organization");
                });
            ...
            modelBuilder.Entity("GE.BandSite.Database.Organization.SesFeedbackEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("SesFeedbackId")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)");
                    ...
                    b.HasIndex("NotificationType", "ReceivedAt");

                    b.ToTable("SesFeedbackEvent", "Organization");
                });

            modelBuilder.Entity("GE.BandSite.Database.Organization.SesFeedbackRecipient", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<string>("BounceAction")
                        .HasMaxLength(40)
                        .HasColumnType("character varying(40)");

                    b.Property<string>("BounceStatus")
                        .HasMaxLength(50)
                    ...
                    b.Property<string>("ComplaintFeedbackType")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");
                    ...
                    b.ToTable("SesFeedbackRecipient", "Organization");
                });
            ...
            modelBuilder.Entity("GE.BandSite.Database.Organization.EmailSuppression", b =>
                {
                    b.HasOne("GE.BandSite.Database.Organization.SesFeedbackEvent", "FeedbackEvent")
                        .WithMany()
                        .HasForeignKey("FeedbackEventId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.Navigation("FeedbackEvent");
                });
